...
const generatePDF = async () => {
    ...
    doc.text("Historical Data Peminjaman Alat Laboratorium Teknik Informatika", 10, 10);
    doc.setFontSize(10);
    ...
    // Download PDF
    doc.save(`peminjaman-alat-${moment().format("DD-MM-YYYY")}.pdf`);
};
