  ...
  return (
    <Wrapper>
      <div className="mx-10 my-10 bg-white shadow-lg py-5 px-5 rounded-sm">
        ...
        <Link
          to={`/admin/dashboard-laboran/${dataContext.id}/pemeriksaan/hardware/tambah`}
                ...
                return (
                  <tr key={val.id}>
                    ...
                    <td className="border p-2 text-white flex items-center text-center justify-center">
                      ...
                      <Link
                        to={`/admin/dashboard-laboran/${dataContext.id}/pemeriksaan/hardware/${val.id}/edit`}
                      >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <h1 className=" text-md mb-5 ">
                              Apakah anda yakin sudah selesai melakukan
                              pengecekan?
                            </h1>

                            <Form
                              method="post"
                              action={`${val.id}/validasi-laboran`}
                              className="flex items-center justify-center justify-items-center text-center"
                            >
                              <button
                                type="submit"
                      ...
                      <button
                        onClick={() => setShowModalValidasiLaboran(true)}
