...
export const action = async ({ request, params }) => {
  ...
  try {
    ...
    return redirect(
      `/admin/dashboard-laboran/${params.id}/pemeriksaan/hardware/${params.idPemeriksaan}/detail-ftti4`
    );
  } catch (error) {
    console.log(error);
...
const TambahDataDetailPemeriksaanHardwareFtti4 = () => {
   return (
     <Wrapper>
       <NavbarAdmin />
       <div className="mx-64 my-10 bg-white shadow-xl py-5 px-5 rounded-sm">
         <h1 className="text-biru-uhamka font-bold text-xl text-center">
           Tambah Detail Pemeriksaan Hardware FTTI4
         </h1>
         <div>
           <Form
             method="post"
...
export default TambahDataDetailPemeriksaanHardwareFtti4;
