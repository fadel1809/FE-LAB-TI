...
export const action = async ({request,params}) => {
   ...
   try {
    await customFetch.post("v1/inventaris/ftti1",data,{withCredentials:true})
    toast.success("Aset Berhasil Ditambahkan!")
    return redirect(`/admin/dashboard-laboran/${params.id}/inventaris/FTTI1`);
  } catch (error) {
    console.log(error)
   }
}
const TambahDataInventarisFtti1 = () => {
...
export default TambahDataInventarisFtti1;
