...
const EditDetailPemeriksaanSoftwareFtti1 = () => {
     ...
     <Wrapper>
       ...
       <div className="mx-64 my-10 bg-white shadow-lg py-5 px-5 rounded-sm">
         <h1 className="text-biru-uhamka font-bold text-xl text-center">
           Edit Detail Pemeriksaan Software FTTI1
         </h1>
         <div>
           <Form
             method="post"
...
export default EditDetailPemeriksaanSoftwareFtti1