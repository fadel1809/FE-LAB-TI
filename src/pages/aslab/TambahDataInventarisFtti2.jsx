...
export const action = async ({ request, params }) => {
  ...
  try {
    await customFetch.post("v1/inventaris/ftti2", data, {
      withCredentials: true,
    });
    toast.success("Aset Berhasil Ditambahkan!");
    return redirect(`/admin/dashboard-aslab/${params.id}/inventaris/FTTI2`);
  } catch (error) {
    console.log(error);
  }
};

const TambahDataInventarisFtti2 = () => {
 return (
   <Wrapper>
     <div className="mx-64 my-10 bg-white shadow-lg py-5 px-5 rounded-sm">
       ...
       <h1 className="text-biru-uhamka font-bold text-xl text-center">
         Tambah Data Aset Inventaris FTTI2
       </h1>
       <div>
         <Form
...
export default TambahDataInventarisFtti2;
