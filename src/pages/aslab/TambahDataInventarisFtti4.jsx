...
export const action = async ({ request, params }) => {
  ...
  try {
    await customFetch.post("v1/inventaris/ftti4", data, {
...
const TambahDataInventarisFtti4 = () => {
 return (
   <Wrapper>
     <div className="mx-64 my-10 bg-white shadow-lg py-5 px-5 rounded-sm">
       ...
       <h1 className="text-biru-uhamka font-bold text-xl text-center">
         Tambah Data Aset Inventaris FTTI4
       </h1>
       <div>
         <Form
...
export default TambahDataInventarisFtti4;
