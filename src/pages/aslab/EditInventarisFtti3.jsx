...
export const loader = async ({ params }) => {
  try {
    const result = await customFetch.get(
      `v1/inventaris/ftti3/${params.idInventaris}`,
...
export const action = async ({ request, params }) => {
  ...
  try {
    await customFetch.put(`v1/inventaris/ftti3/${params.idInventaris}`, data, {
      withCredentials: true,
    });
...
export default EditInventarisFtti3;
