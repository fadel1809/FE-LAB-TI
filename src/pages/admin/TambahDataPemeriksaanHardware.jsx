...
import Wrapper from "../../assets/wrappers/pemeriksaanHardware.js";
import BackButton from "../../components/BackButton.jsx";
import {FaCircleArrowDown, FaCirclePlus} from "react-icons/fa6";
...
export const action = async ({request, params}) => {
    ...
    try {
        ...
        return redirect(`/admin/dashboard-superadmin/${params.id}/pemeriksaan/hardware`);
    } catch (error) {
        console.log(error)
        return error
    }
