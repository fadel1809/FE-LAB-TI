...
export const action = async ({request,params})=>{
    ...
    try {
        await customFetch.post(`v1/pemeriksaan/detail-hardware/${params.idPemeriksaan}`,data,{withCredentials:true})
        toast.success("Detail Pemeriksaan Hardware Berhasil Dibuat!")
        return redirect(`/admin/dashboard-superadmin/${params.id}/pemeriksaan/hardware/${params.idPemeriksaan}/detail-ftti1`);
    } catch (error) {
        console.log(error)
        ...
        <Wrapper>
            ...
            <div className="mx-64 my-10 bg-white shadow-lg py-5 px-5 rounded-sm">
                ...
                <h1 className="text-biru-uhamka font-bold text-xl text-center">
                    Tambah Detail Pemeriksaan Hardware FTTI1
                </h1>
                <div>
                    <Form
                        method="post"
