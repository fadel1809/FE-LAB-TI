...
export const action = async({request,params}) => {
    ...
    try {
        await customFetch.put(`v1/pemeriksaan/detail-hardware/${params.idPemeriksaan}/detail/${params.idDetail}`,data,{ withCredentials: true,})
        toast.success("Detail Pemeriksaan Berhasil di Ubah")
        return redirect(
            `/admin/dashboard-superadmin/${params.id}/pemeriksaan/hardware/${params.idPemeriksaan}/detail-ftti1`
        );
    } catch (error) {
        console.log(error)
    }
...
export const loader = async({params}) => {
    try {
        const response = await customFetch.get(`v1/pemeriksaan/detail-hardware/${params.idPemeriksaan}/detail/${params.idDetail}`,{withCredentials:true})
        return response.data.data
    } catch (error) {
        console.log(error)
    }
}
const EditDetailPemeriksaanHardwareFtti1 = () => {
        ...
        <Wrapper>
            ...
            <div className="mx-64 my-10 bg-white shadow-xl py-5 px-5 rounded-sm">
                ...
                <h1 className="text-biru-uhamka font-bold text-xl text-center">
                    Edit Detail Pemeriksaan Hardware FTTI1
                </h1>
                <div>
                    <Form
                        method="post"
...
export default EditDetailPemeriksaanHardwareFtti1