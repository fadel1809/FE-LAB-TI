                ...
                <div className="mx-10 ml-10  bg-white shadow-lg py-5 px-5 rounded-sm">
                    ...
                    <table className="table-auto lg:overflow-auto-x  border border-collapse">
                        ...
                        <tr>
                            ...
                            <th className="border py-2 px-1 text-sm">Kabel Lan</th>
                        ...
                        {detailPemeriksaan.map((val) => {
                            return (
                                <tr key={val.id}>
                                    ...
                                    <td className="border px-2 text-xs">{val.kabel_lan}</td>

                                    <td className="border px-2 text-xs">{val.keterangan}</td>
                                    <td className="border py-2 text-lg">
                                        <Link
                                            to={`/admin/dashboard-superadmin/${id}/pemeriksaan/hardware/${user[0].id}/detail-ftti2/${val.id}/edit`}
                                        >
                                            <button
                                                type="button"
...
export default DetailpemeriksaanHardwareFtti2;
