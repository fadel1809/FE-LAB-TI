...
import {Link, useOutletContext, useLoaderData, Form, useNavigate, useSearchParams} from "react-router-dom";
                    ...
                    <table className="table-auto my-5 w-full border border-collapse my-5">
                        ...
                        {data.map((val) => {
                            if (val.laboratorium == "FTTI1") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/software/${val.id}/detail-ftti1`;
                            }
                            if (val.laboratorium == "FTTI2") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/software/${val.id}/detail-ftti2`;
                            }
                            if (val.laboratorium == "FTTI3") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/software/${val.id}/detail-ftti3`;
                            }
                            if (val.laboratorium == "FTTI4") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/software/${val.id}/detail-ftti4`;
                            }
                            return (
                                <tr key={val.id}>
                                    ...
                                    <td className=" p-2 text-white flex items-center text-center justify-center border">
                                        <Link to={detailLink}>
                                        ...
                                        <Link
                                            to={`/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/software/${val.id}/edit`}
                                        >
