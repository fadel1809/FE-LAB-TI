                    ...
                    <table className="table-auto w-full border border-collapse my-5">
                        ...
                        {data.map((val) => {
                            if (val.laboratorium == "FTTI1") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/hardware/${val.id}/detail-ftti1`;
                            }
                            if (val.laboratorium == "FTTI2") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/hardware/${val.id}/detail-ftti2`;
                            }
                            if (val.laboratorium == "FTTI3") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/hardware/${val.id}/detail-ftti3`;
                            }
                            if (val.laboratorium == "FTTI4") {
                                detailLink = `/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/hardware/${val.id}/detail-ftti4`;
                            }
                            return (
                                <tr key={val.id} className={"border"}>
                                    ...
                                    <td className=" p-2 text-white flex items-center text-center justify-center">
                                        ...
                                        <Link
                                            to={`/admin/dashboard-superadmin/${dataContext.id}/pemeriksaan/hardware/${val.id}/edit`}
                                        >
