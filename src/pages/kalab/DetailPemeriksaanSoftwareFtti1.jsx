         ...
         <table className="table-auto sm:overflow-auto-x lg:w-full border border-collapse">
           <thead className="border border-collapse bg-gray-200">
             <tr>
               ...
               <th className="border py-2 px-1 text-sm">Sublime</th>
             ...
             {detailPemeriksaan.map((val) => {
               return (
                 <tr key={val.id}>
                   ...
                   <td className="border px-2 text-xs">{val.sublime}</td>
                   <td className="border px-2 text-xs">{val.pycharm}</td>
                   <td className="border px-2 text-xs">{val.cpu_simulator}</td>
                   <td className="border px-2 text-xs">{val.veyon}</td>
                   <td className="border py-2 text-lg">
                     <Link
                       to={`/admin/dashboard-laboran/${id}/pemeriksaan/software/${user[0].id}/detail-ftti1/${val.id}/edit`}
                     >
                       <button
                         type="button"
...
export default DetailPemeriksaanSoftwareFtti1;
